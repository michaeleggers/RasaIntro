...
# Does the model automatically choose the correct action just by its name?
# Because it works without explicitly stating that this action should run
# when the pizza form gets active.
...
class ValidateForm2(FormValidationAction):
    def name(self) -> Text:
